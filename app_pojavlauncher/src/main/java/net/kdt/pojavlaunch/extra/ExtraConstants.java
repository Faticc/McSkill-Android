...
public class ExtraConstants {
    ...
    /* ExtraCore constant: mcskill username/password authentication to perform, as a String[]{username, password} */
    public static final String MCSKILL_LOGIN_TODO = "mcskill_login_todo";
